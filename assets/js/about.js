$(document).ready(function() {
  $('#about').click(function() {
    ...
    $('#header').addClass('slideRight', function() {
      $('#main').fadeIn(1500);
    });
  });
});
